...
public:
  ...
  static void getEdgePointIndices(Edges edge, Points &outP1, Points &outP2) {
	switch (edge) {
	case NearLeftEdge:outP1 = NearTopLeft;
	  outP2 = NearBottomLeft;
	  return;
	case NearBottomEdge:outP1 = NearBottomLeft;
	  outP2 = NearBottomRight;
	  return;
	case NearRightEdge:outP1 = NearBottomRight;
	  outP2 = NearTopRight;
	  return;
	...
	case FarLeftEdge:outP1 = FarBottomLeft;
	  outP2 = FarTopLeft;
	  return;
	case FarTopEdge:outP1 = FarTopLeft;
	  outP2 = FarTopRight;
	  return;
	case FarRightEdge:outP1 = FarTopRight;
	  outP2 = FarBottomRight;
	  return;
	case FarBottomEdge:outP1 = FarBottomRight;
	  outP2 = FarBottomLeft;
	  return;

	case LeftTopEdge:outP1 = NearTopLeft;
	  outP2 = FarTopLeft;
	  return;
	case LeftBottomEdge:outP1 = FarBottomLeft;
	  outP2 = NearBottomLeft;
	  return;

	default:
	case RightTopEdge:outP1 = FarTopRight;
	  outP2 = NearTopRight;
	  return;
	case RightBottomEdge:outP1 = NearBottomRight;
	  outP2 = FarBottomRight;
	  return;
	}
  }
